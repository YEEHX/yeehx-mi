...
- **像 Finder 一样浏览**：外挂硬盘直接进，每段素材一张代表帧、零延迟速览，一眼看清每段大概拍了什么；星级选片、键盘流操作
...
- **「必须苹果电脑吗？」** —— 目前是。Windows 版移植中，关注下方任一平台第一时间知道。
...
| OpenAI 兼容 API（推荐） | 任何 Mac、要省心 | 填地址 + Key（如小米 MiMo `platform.xiaomimimo.com`），充 5-10 元就够打完一大库；AI 算力全在云端，电脑能开网页就行，12 路并发一晚上打完 |
